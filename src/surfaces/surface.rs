...
pub trait Surface {
    ...
    fn sample(&self,  o: &Vec3, rv: &Vec2) -> Option<(EmitterRecord, Vec3)> {unimplemented!()}

    /// Return the probability density of the sample generated by #sample
    fn pdf(&self, o: &Vec3, dir: &Vec3) -> f32 {unimplemented!()}

    /// Return whether or not this Surface's Material is emissive.
    fn is_emissive(&self) -> bool {unimplemented!()}
}
